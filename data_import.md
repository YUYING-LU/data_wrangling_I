...
``` r
pups_df = read_csv('/Users/lyy/Documents/Columbia/2024-2025-1/Data Science I/week3/data_wrangling_I/data/FAS_pups.csv')
```

It doesn’t work if the folder is moved.

## Look at read_csv potions
